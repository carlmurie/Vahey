...
**Microarrays**  
HGU133A 2.0 - 14500 genes (used for all T5 samples)  
HGU133 Plus 2.0 - 38500 genes (used for all non-T5 samples)  
  
The genes in the HGU133A are a subset of the genes in the HG133 Plus chip. The intersection of the genes from the 2 chips were used in this analysis which resulted in 14500 genes.  
...
* **parasitemia** - response to malaria challenge
    ...
    + Unknown - not vaccinated and not challenged  
