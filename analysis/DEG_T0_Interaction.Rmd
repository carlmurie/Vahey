---
title: DEG analysis - baseline (T0) vs all other time periods
...
fit1_t <- topTable(eb_fit1, number=Inf, coef="visitT1:diseaseNonProtected", sort.by="P")
num_sig <- sum(fit1_t$adj.P.Val <= fdr_cut)

graphs <- createDEGGraphs(fit1_t, title="T1 - T0", fdrCut=fdr_cut)
...
graphs <- createDEGGraphs(fit1_t, title="T2 - T0", fdrCut=fdr_cut)
grid.arrange(grobs=graphs, nrow=1)
...
graphs <- createDEGGraphs(fit1_t, title="T3 - T0", fdrCut=fdr_cut)
grid.arrange(grobs=graphs, nrow=1)
...
graphs <- createDEGGraphs(fit1_t, title="T4 - T0", fdrCut=fdr_cut)
grid.arrange(grobs=graphs, nrow=1)
...
graphs <- createDEGGraphs(fit1_t, title="T5 - T0", fdrCut=fdr_cut)
grid.arrange(grobs=graphs, nrow=1)
